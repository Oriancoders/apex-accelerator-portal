  ...
  return (
    <div className="widget-card">
      <div className="widget-card-header">
        ...
        <a href="/knowledge" className="text-primary text-xs hover:underline">Browse All</a>
      </div>
      <div className="widget-card-body space-y-3">
        {articles.map((a) => (
          <div key={a.title} className="p-2 rounded-lg hover:bg-muted transition-colors cursor-pointer">
