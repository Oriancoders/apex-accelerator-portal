    ...
    <AdminLayout>
      <div className="space-y-5">
        <div className="flex items-center justify-between gap-3">
          <Button variant="outline" className="rounded-ds-md" onClick={() => navigate("/admin/tickets")}>
        ...
        {isLoading && (
          <div className="rounded-ds-xl border border-border-subtle bg-card p-6 space-y-3">
            <div className="h-7 w-1/2 bg-muted animate-pulse rounded" />
            <div className="h-4 w-1/3 bg-muted animate-pulse rounded" />
            <div className="h-56 bg-muted animate-pulse rounded-ds-md" />
          </div>
        )}

        {isError && (
          <div className="rounded-ds-xl border border-destructive/20 bg-destructive/5 p-6">
            <p className="text-sm text-destructive font-medium">Unable to load ticket details.</p>
            <Button
              variant="outline"
              className="rounded-ds-md mt-3"
              onClick={async () => {
