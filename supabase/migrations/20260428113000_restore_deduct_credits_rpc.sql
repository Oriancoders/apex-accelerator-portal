...
GRANT EXECUTE ON FUNCTION public.deduct_credits(uuid, numeric, uuid, text) TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.deduct_credits(uuid, integer, uuid, text) TO anon, authenticated;
